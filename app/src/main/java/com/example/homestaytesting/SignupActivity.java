...
public class SignupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void registerUser(){
        ...
        final String profiledescription = "High-energy Guest Service Representative focused on promoting customer satisfaction through exceptional service and maintaining outstanding homestay accommodations.";
