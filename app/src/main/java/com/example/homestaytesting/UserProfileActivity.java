...
public class UserProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText editTextName, editTextEmail, editTextContc, editDetails;
        ...
        databaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    String userProfileDetails = dataSnapshot.child("profiledescription").getValue().toString();
                    String userRole = dataSnapshot.child("role").getValue().toString();

                    editTextName.setText(userName);
                    tvEmail.setText(userEmail);
                    editTextContc.setText(userContact);
                    editDetails.setText(userProfileDetails);
